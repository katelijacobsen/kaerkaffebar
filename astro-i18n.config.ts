...
export default defineAstroI18nConfig({
  ...
  translations: {
    ...
    "/arrangement": {
      ...
      "Vi stiller gerne vores hyggelige og indbydende rammer til rådighed": "We're happy to offer our cozy and inviting space",
      "for alt fra fødselsdagsfester og firmaarrangementer til PR-events og meget mere –": "for everything from birthday parties and corporate events to PR events and much more –",
      "du skal blot sende os en forespørgelse, så tager vi den derfra.": "just send us an inquiry and we'll take it from there.",
      "Blue illustration of a vase with flowers": "Blue illustration of a vase with flowers",
      "Small cakes with burned cream and edible flowers on top": "Small cakes with burned cream and edible flowers on top",
      "Send forespørgelse": "Send inquiry",
      "White illustration of flowing teapot with three teacups": "White illustration of flowing teapot with three teacups",
      "Arrangement": "Gathering",
      "Hold dit næste arrangement hos os": "Host your next gathering with us",
      "Små selskaber i hyggelige rammer – perfekt til fødselsdage, babyshowers og bogklubber.": "Small gatherings in cozy surroundings – perfect for birthdays, baby showers and book clubs.",
      "Hvis du leder efter det ideelle sted til dit næste arrangement, behøver du ikke lede længere end Kær Kaffebar.": "If you're looking for the ideal place for your next gathering, look no further than Kær Kaffebar.",
      "Send en forespørgelse om arrangement og så vil vi kontakte dig angående flere detaljer.": "Send an inquiry about your gathering and we'll contact you with more details.",
      "Lad os sammen skabe et mindeværdigt arrangement, som dine gæster vil tale om i lang tid fremover!": "Let's create a memorable event together that your guests will talk about for a long time!",
      "White illustration of fork, knife and spoon": "White illustration of fork, knife and spoon",
      "Event": "Event",
      "Planlæg et unikt event på Kær Kaffebar": "Plan a unique event at Kær Kaffebar",
      "Workshops, pop-ups eller private aftenarrangementer? Vi hjælper dig med at skabe stemningen": "Workshops, pop-ups or private evening events? We'll help you create the right atmosphere",
      "Hos Kær Kaffebar tilbyder vi den perfekte ramme for dit næste PR-event.": "At Kær Kaffebar we offer the perfect setting for your next PR event.",
      "Vores hyggelige og stemningsfulde café i hjertet af Valby er ideel til at skabe en intim og imødekommende atmosfære, hvor din virksomheds budskab kan komme til sin ret.": "Our cozy and atmospheric café in the heart of Valby is ideal for creating an intimate and welcoming atmosphere where your company's message can shine.",
      "Med vores flotte indretning, udendørs siddepladser i solen og lækre udvalg af økologisk kaffe, friskpresset juice, og hjemmelavede specialiteter, kan du give dine gæster en uforglemmelig oplevelse.": "With our beautiful interior, outdoor seating in the sun and delicious selection of organic coffee, freshly pressed juice, and homemade specialties, you can give your guests an unforgettable experience.",
      "Uanset om det drejer sig om en produktlancering, en netværksbegivenhed eller andet, kan vi skræddersy arrangementet til dine behov. Vi tilbyder muligheden for at reservere hele caféen og vores dedikerede personale sørger for, at alt forløber glat. Vi kan desuden arrangere specialmenuer, der passer til dit event, med tanke for dit brands identitet.": "Whether it's a product launch, networking event or something else, we can tailor the event to your needs. We offer the option to reserve the entire café and our dedicated staff will ensure everything runs smoothly. We can also arrange special menus that suit your event, with consideration for your brand identity.",
      "Brown illustration of whole and sliced lemons": "Brown illustration of whole and sliced lemons",
      "Catering": "Catering",
      "Catering med kærlighed og kvalitet": "Catering with love and quality",
      "Bestil morgenmad, frokost eller kagebord til din næste sammenkomst – lavet med omtanke.": "Order breakfast, lunch or a cake table for your next gathering – made with care.",
      "Lad os tage os af maden – så du kan tage dig af gæsterne.": "Let us take care of the food – so you can take care of the guests.",
      "Hos Kær Kaffebar tilbyder vi catering til både private og professionelle arrangementer, store som små. Uanset om du planlægger en fødselsdag, et firmaevent, en reception eller et møde, står vi klar med smagfulde løsninger, der passer perfekt til anledningen.": "At Kær Kaffebar we offer catering for both private and professional events, large and small. Whether you're planning a birthday, corporate event, reception or meeting, we're ready with tasty solutions that perfectly suit the occasion.",
      "Vi laver alt fra friskbagte kager og brød til lette anretninger, brunch, frokost og specialkaffe. Vores retter er lavet med kærlighed og omtanke – og vi bruger friske, økologiske råvarer, hvor det er muligt.": "We make everything from freshly baked cakes and bread to light dishes, brunch, lunch and specialty coffee. Our dishes are made with love and care – and we use fresh, organic ingredients when possible.",
      "Har du særlige ønsker eller behov? Vi skræddersyr gerne en menu, der matcher dine præferencer og dit arrangement – både i smag og stil.": "Do you have special wishes or needs? We're happy to tailor a menu that matches your preferences and your event – both in taste and style.",
      "Brown illustration of a croissant": "Brown illustration of a croissant",
      "Kage og bestilling": "Cakes & orders",
      "Bestil hjemmelavede kager til enhver lejlighed": "Order homemade cakes for any occasion",
      "Bryllup, fødselsdage eller bare fordi - vi bager med smag og stil": "Weddings, birthdays or just because - we bake with taste and style",
      "Skal der lidt ekstra sødt på bordet?": "Need something extra sweet on the table?",
      "Bestil en eller flere af vores populære hjemmebagte kager til din fest eller fejring.": "Order one or more of our popular homemade cakes for your party or celebration.",
      "Vi bager efter sæson og tilbyder alt fra klassiske favoritter til unikke specialiteter.": "We bake according to season and offer everything from classic favorites to unique specialties.",
      },
    },
    "/menu": {
      en: {
    ...
    "/runningclub": {
      en: {
      "Kær løbeklub": "Kær Running Club",
      "Kær Klubben's løbeklub i Valby har": "Kær Club's running club in Valby has",
      "fokus på det sociale og på at samle lokalsamfundet": "focus on the social aspect and bringing the local community together",
      "samtidig med at vi bevæger os": "while we get moving",
      "Ruten i søndermarken er 2,5 km, så alle kan være med": "The route in Søndermarken is 2.5 km, so everyone can participate",
      "Er man hurtig, kan man nå den 2 gange!": "If you're fast, you can do it twice!",
      "løbende kaffekop illustration": "running coffee cup illustration",
      "Kommende ture": "Upcoming runs",
      "Vælg måned": "Select month",
      "Filtrer begivenheder efter måned": "Filter events by month",
      "Januar": "January",
      "Februar": "February",
      "Marts": "March",
      "April": "April",
      ...
      "Telefonnummer": "Phone number",
      "Tilmeld": "Sign up",
      "OBS: ved afmeldning skriv til nummeret: 81 61 09 00 mindst 24 timer inden.": "NOTE: To cancel, please text the number: 81 61 09 00 at least 24 hours in advance.",
      "FAQ": "FAQ",
      "Hvor mødes vi?": "Where do we meet?",
      "Vi mødes ved Kær Kaffebar, Valby Lannggade 86C, 2500 Valby.": "We meet at Kær Kaffebar, Valby Lannggade 86C, 2500 Valby.",
      "Hvad gør jeg, hvis jeg ikke kan komme alligevel?": "What should I do if I can't make it after all?",
      "Hvis du efter tilmelding finder ud af, at du ikke kan komme alligevel, så skriv til nummeret: 81610900 mindst 24 timer inden, så vi ved, hvor mange vi skal regne med.": "If you find out after signing up that you can't make it, please text the number: 81610900 at least 24 hours in advance so we know how many to expect.",
      "Får man gratis kaffe?": "Do you get free coffee?",
      "Nej vi giver desværre ikke gratis kaffe, men vi giver et ingefærshot og super hyggelig stemning. Kaffebaren er selvfølgelig åben, så man er mere end velkommen til at nyde mad eller drikkevarer udenfor ved vores café borde eller inden i vores hyggelig lokale.": "No, unfortunately we don't offer free coffee, but we do provide a ginger shot and a super cozy atmosphere. The coffee bar is of course open, so you're more than welcome to enjoy food or drinks outside at our café tables or inside in our cozy space.",
      "billeder-af-to-piger-med-en-løbeklub-t-shirt": "pictures of two girls in running club t-shirts",
      "Hos Kær Kaffebar handler det ikke kun om tempo, men om fællesskab og lokale bånd.": "At Kær Kaffebar it's not just about speed, but about community and local connections.",
